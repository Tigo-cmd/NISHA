...
const DEFAULT_MARKERS = [
  { lat: 37.78, lng: -122.42, label: "Lagos" },
  { lat: 51.51, lng: -0.13, label: "Abuja" },
  { lat: 35.68, lng: 139.69, label: "Kano" },
  { lat: -33.87, lng: 151.21, label: "Port Harcourt" },
  { lat: 1.35, lng: 103.82, label: "Enugu" },
  { lat: 55.76, lng: 37.62, label: "Ibadan" },
  { lat: -23.55, lng: -46.63, label: "Kaduna" },
  { lat: 19.43, lng: -99.13, label: "Maiduguri" },
  { lat: 28.61, lng: 77.21, label: "Sokoto" },
  { lat: 36.19, lng: 44.01, label: "Calabar" },
];
...
export function Globe({
  className,
  size = 600,
  dotColor = "rgba(57, 211, 83, ALPHA)", // NISHA Green base
  arcColor = "rgba(57, 211, 83, 0.5)",
  markerColor = "rgba(57, 211, 83, 1)",
  ...
  const draw = useCallback(() => {
    ...
    glowGrad.addColorStop(0, "rgba(57, 211, 83, 0.03)");
    glowGrad.addColorStop(1, "rgba(57, 211, 83, 0)");
