...
export function WorldMap({ 
  ...
  const svgMap = useMemo(
    () => map.getSVG({
      radius: 0.22,
      color: theme === "dark" ? "#39d35340" : "#39d35340",
      shape: "circle",
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-xs font-mono font-medium px-2 py-0.5 rounded-sm bg-[#39d353]/10 text-[#39d353] border border-[#39d353]/30 shadow-[0_0_10px_rgba(57,211,83,0.2)]">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 bg-black/90 text-[#39d353] px-3 py-2 rounded-lg text-sm font-medium backdrop-blur-sm sm:hidden border border-[#39d353]/30"
          >
            {hoveredLocation}
          </motion.div>
        )}
